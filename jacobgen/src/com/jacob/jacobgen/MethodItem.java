...
public class MethodItem {
	...
	private Vector<ParameterItem> parametersList;
	...
	protected MethodItem(String line) throws IllegalFormatException {
		parametersList = new Vector<ParameterItem>();
		extractData(line);
	}
	...
	protected void extractParameters(String parameters)
		...
		while (st.hasMoreTokens()) {
			...
			ParameterItem pi = new ParameterItem(parameterName, parameterType,
					computeVarType(parameterType), direction, optional);
	...
	protected void computeCustomReturnType() {
		...
		String[] types = { "void", "Object", "short", "int", "float", "double",
				"long", "java.util.Date", "String", "Dispatch", "boolean",
				"Variant", "byte" };
	...
	public static int computeMethodType(String type)
			throws IllegalFormatException {
	...
	public static String computeVarType(String type)
			throws IllegalFormatException {
		String result = "";
